...
def visualize():
    ...
    df_last = df[df["año"].between(min_year, max_year)].copy()

    # Mostrar por país (últimos N años)
    for pais in paises:
        bloque = df_last[df_last["pais"] == pais].sort_values("año")
        print("\n==============================")
        print(f"📌 {pais}")
        print("==============================")
    ...
    print("\n==============================")
    print("📌 Resumen: último año disponible por país")
    print("==============================")
    idx = df.sort_values("año").groupby("pais")["año"].idxmax()
